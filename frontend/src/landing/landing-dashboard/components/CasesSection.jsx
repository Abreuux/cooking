  ...
  const cases = [
    {
      ...
      metrics: [
        { label: 'Conversão', value: '+40%', color: '#4CAF50' },
        { label: 'ROI', value: '+280%', color: '#2196F3' },
        { label: 'Tempo de análise', value: '-75%', color: '#FF9800' },
      ],
    ...
    },
    {
      ...
      metrics: [
        { label: 'Economia', value: 'R$ 2M', color: '#4CAF50' },
        { label: 'Estoque parado', value: '-30%', color: '#2196F3' },
        { label: 'Precisão previsão', value: '+85%', color: '#FF9800' },
      ],
    ...
    },
    {
      ...
      metrics: [
        { label: 'Churn', value: '-60%', color: '#4CAF50' },
        { label: 'Retenção', value: '+45%', color: '#2196F3' },
        { label: 'LTV', value: '+120%', color: '#FF9800' },
      ],

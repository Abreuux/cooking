...
const TechIllustration = () => {
  ...
  const floatingElements = [
    { icon: <DataObjectIcon />, color: theme.palette.primary.main, delay: 0 },
    { icon: <PsychologyIcon />, color: theme.palette.secondary.main, delay: 0.5 },
    { icon: <CloudIcon />, color: theme.palette.accent.main, delay: 1 },
    { icon: <AutoGraphIcon />, color: '#4CAF50', delay: 1.5 },
    { icon: <TrendingUpIcon />, color: '#FF9800', delay: 2 },
  ];
          ...
          >
            <Box
              sx={{
                ...
                alignItems: 'center',
                justifyContent: 'center',
                boxShadow: `0 8px 25px ${element.color}25`,
                cursor: 'pointer',
                transition: 'all 0.3s ease',
                '&:hover': {
                  transform: 'scale(1.1)',
                  boxShadow: `0 12px 35px ${element.color}35`,
                },
              }}
            >
              {React.cloneElement(element.icon, {
                sx: { fontSize: 28, color: element.color }
              })}
            </Box>
          </motion.div>
        );
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    >
                      Redução em<br />Tempo de Análise
                    </Typography>
                  </Box>
                </Box>
              </motion.div>
            ...
            <Box sx={{ textAlign: 'center', mt: 8 }}>
              ...
              >
                ...
                {[
                  ...
                  { name: 'DataFlow', color: theme.palette.secondary.main },
                  { name: 'InnovateLab', color: theme.palette.accent.main },
                  { name: 'SmartBiz', color: '#4CAF50' },
                  { name: 'FutureData', color: '#FF9800' },
                ].map((company, index) => (
                  <motion.div
                    key={index}
